...
def get_traj(test_type, pa, env, episode_max_length, pg_resume=None, render=False):
    ...
    if test_type == 'PG' or test_type == 'PG-test':  # load trained parameters
...
def launch(pa, pg_resume=None, render=False, plot=False, repre='image', end='no_new_job'):
    ...
    # test_types = ['Random-mul', 'Packer-mul', 'Tetris-mul', 'SJF-mul']  # 'Tetris2',
    test_types = ['Tetris-mul', 'SJF-mul', 'Random-mul', 'Packer-mul']  # 'Tetris2',
...
def main():
    ...
    pg_resume = 'data-test4/data/tmp_1800.pkl'
